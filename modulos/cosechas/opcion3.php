...
<section class="content-header">
  <h1>
    <i class="fa fa-leaf"></i>&nbsp;Ensilado con grano
  </h1>
  <ol class="breadcrumb">
    ...
    <i class="fa fa-angle-right" style="color: #0C0303"></i>
    &nbsp;&nbsp;
    <li class="active"><i class="fa fa-leaf"></i>&nbsp;Ensilado con grano</li>
  </ol>
</section>
<!-- Main content -->
<section class="content">
  <div class="row">
      <div class="box box-primary">
        <!-- /.box-header -->
        <div class="box-body">
        <form action="" role="form" name="frmopcion3" id="frmopcion3" enctype="multipart/form-data" autocomplete="off" onsubmit="return false">
          <input type="hidden" name="enc_id" id="enc_id" readonly>
          <fieldset>
            <div class="form-group col-md-3">
                <label>Costo total de la siembra: </label>
                <input type="text" class="form-control" name="grano" id="grano" readonly placeholder="0.00">
            </div>
            <div class="form-group col-md-3">
                <label>Bodega: </label>
...
$('#guardar').click(function () {
    $.validate({
        onSuccess: function(form){
            var formulario = document.getElementById("frmopcion3");
            var formData = new FormData(formulario);
            $.ajax({
                url: "procesos/cosecha/guardar_opcion3.php",
                type: "POST",
                dataType: "json",
                data: formData,
                cache: false,
