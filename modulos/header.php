      <header class="main-header">
        ...
        <a href="?mod=inicio" class="logo">
          ...
          <span class="logo-mini"><img src="img/pie3.png" alt="Inicio" class="img-circle" width="35" height="25"/></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><img src="img/pie3.png" alt="Inicio" class="img-circle" width="35" height="25"/>&nbsp;<b>PASO</b> FIRME</span>
        </a>
